    ...
    public static void main(String[] args) {
        ...
        try {
            while (!remaining.isEmpty()) {
                URL newURL = remaining.poll();

                handler.newPage(new Page(newURL));
                // Parse the next URL's page
                parser.parse(new InputStreamReader(newURL.openStream()), handler);
            ...
            System.out.println(((WebIndex) handler.getIndex()).getNumPages());
            ...
            System.out.println(((WebIndex) handler.getIndex()).getTokenMapSize());
        } catch (Exception e) {
